...
set C_INCLUDE_PATH=%SystemDrive%\mingw64\lib\gcc\x86_64-w64-mingw32\14.2.0\include;%SystemDrive%\mingw64\x86_64-w64-mingw32\include;%SystemDrive%\mingw64\x86_64-w64-mingw32\include\sec_api;%SystemDrive%\mingw64\include;%SystemDrive%\mingw64\opt\include;%VCPKG_ROOT%\installed\x64-mingw-dynamic\include
set CPLUS_INCLUDE_PATH=%SystemDrive%\mingw64\lib\gcc\x86_64-w64-mingw32\14.2.0\include;%SystemDrive%\mingw64\lib\gcc\x86_64-w64-mingw32\14.2.0\include\c++;%SystemDrive%\mingw64\x86_64-w64-mingw32\include;%SystemDrive%\mingw64\x86_64-w64-mingw32\include\sec_api;%SystemDrive%\mingw64\include;%SystemDrive%\mingw64\opt\include;%VCPKG_ROOT%\installed\x64-mingw-dynamic\include
set INCLUDE=%SystemDrive%\mingw64\lib\gcc\x86_64-w64-mingw32\14.2.0\include;%SystemDrive%\mingw64\lib\gcc\x86_64-w64-mingw32\14.2.0\include\c++;%SystemDrive%\mingw64\x86_64-w64-mingw32\include;%SystemDrive%\mingw64\x86_64-w64-mingw32\include\sec_api;%SystemDrive%\mingw64\include;%SystemDrive%\mingw64\opt\include;%VCPKG_ROOT%\installed\x64-mingw-dynamic\include
set LIBRARY_PATH=%SystemDrive%\mingw64\lib;%SystemDrive%\mingw64\lib\gcc\x86_64-w64-mingw32\14.2.0;%SystemDrive%\mingw64\opt\lib;%SystemDrive%\mingw64\x86_64-w64-mingw32\lib;%VCPKG_ROOT%\installed\x64-mingw-dynamic\lib
